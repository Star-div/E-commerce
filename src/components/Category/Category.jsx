    ...
    <div className='py-8'>
      <div className='container'>
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
            {/* First line */}
            <div className='py-10 pl-5 bg-gradient-to-br from-black/90 to-blacl/70 text-white rounded-3xl relative h-[320px] flex items-end'>
              <div>
                <div className='mb-4 '>
                  <p className='mb-[2px] text-gray-400'>Enjoy</p>
                  <p className='text-2xl font-semibold mb-[2px]'>Wih</p>
            ...
            <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end'>
              ...
              <img src={Image2} alt=""
               className='w-[320px] absolute bottom-0 right-0 top-0 lg:top-[40px]'/>
            </div>
            {/* Third line */}
